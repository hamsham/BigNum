...
int main() {
    try {
        ...
        std::cout << a << std::endl;
        bignum_base10 b{BN_POS, {3,9,2,4,7,5,0,5,1,3,2,9,4,8,5,6,6,9,4,3,6,2,4,5,4,0,3,6,8,3,3,1,6,4,1,2,8,4,6,4,5,3,6,4,7,2,0,7,1,6,4,8,7,2,5,6,5,2,5,9,2,6,1,2,6,4,0,4,1,9,8,8,1,7,4,0}};
        std::cout << b << std::endl;
